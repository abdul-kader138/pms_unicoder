...
class Settings extends Admin_Controller
{
    ...
    public function save_system()
    {
        $input_data = $this->settings_model->array_from_post(array('default_language', 'locale',
            ...
            'auto_close_ticket', 'attendance_report', 'tables_pagination_limit', 'max_file_size', 'recaptcha_secret_key', 'recaptcha_site_key', 'sms_username', 'sms_password', 'sms_sender'));
