...
<div style="width: 100%;">
    <table cellspacing="0" cellpadding="4" border="0" width="100%">
        <tr>
            ...
            <th width="15%" bgcolor="#dddddd" style="border:1px solid #333333; text-align:center;"><?= lang('from_account') ?></th>
            <th width="15%" bgcolor="#dddddd" style="border:1px solid #333333; text-align:center;"><?= lang('to_account') ?></th>
        ...
        foreach ($all_transaction_info as $v_transaction) :
            ...
            <tr style="width: 100%;">
                ...
                <td style="border:1px solid #333333; text-align:center;"><?= $from_account_info->account_name ?></td>
                <td style="border:1px solid #333333; text-align:center;"><?= $to_account_info->account_name ?></td>
        ...
        <tr class="custom-color-with-td">
            <th bgcolor="#dddddd" style="border:1px solid #333333; text-align:center;" colspan="5"><strong><?= lang('total') ?>:</strong></th>
            <td style="border:1px solid #333333; text-align:center;"><strong><?= display_money($total_amount, $curency->symbol) ?></strong></td>
        <tr>
            <?php else: ?>
                <td colspan="6" style="border:1px solid #333333; text-align:center;">
