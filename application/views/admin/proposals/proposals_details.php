                ...
                <ul class="dropdown-menu animated zoomIn">
                   ...
                   <li>
                            <a href="javascript:;" data-toggle="modal" data-target="#send_Sms"
                               title="<?= lang('sms_estimate') ?>"><?= lang('sms_estimate') ?></a>
                        </li>
                    <li>
            ...
            <div class="col-lg-4 col-xs-6 br pv">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        <?php if(config_item('company_phone')){ ?><br/><?= $language_info['phone'] ?> : <?= config_item('company_phone') ?> <?php } ?>
                        <?php if(config_item('company_vat')){ ?><br/><?= lang('vat_number') ?> : <?= config_item('company_vat') ?><?php } ?>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-xs-6 br pv">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        <br> <?= $city ?>, <?= $zipcode ?>
                        <br><?= $country ?>
                        <?php if (!empty($client_info->phone)) { ?><br><?= $language_info['phone'] ?>: <?= $phone ?><?php } ?>
                        <?php if (!empty($client_info->email)) { ?><br><?= lang('email') ?>:<a href="mailto:<?= $email ?>"> <?= $email ?></a><?php } ?>
    ...
    <div class="modal-content">
	  ...
	  $client_info = $this->proposal_model->check_by(array('client_id' => $proposals_info->module_id), 'tbl_client');
       ...
       <div id="resultSend"></div>
                    ...
                    <input type="hidden" name="proposals_id" value="<?= $proposals_info->proposals_id ?>">
                    ...
                    <input type="hidden" name="amount"
                           value="<?= display_money($this->proposal_model->proposal_calculation('total', $proposals_info->proposals_id)) ?>">
        ...
        <div class="form-group clearfix">
                            ...
                            <textarea id="message" name="message" class="form-control"
                                                            rows="6"><?= lang('proposal_sms_template') ?></textarea>
                                                            </div>
                        </div>
                        <hr />
      <div class="form-group clearfix">
       			<button type="submit" name="sbtn" value="1" class="btn btn-primary"><?= lang('submit')?></button>
