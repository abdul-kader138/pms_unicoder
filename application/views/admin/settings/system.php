    ...
    <div class="col-lg-12">
        <form role="form" id="form" action="<?php echo base_url(); ?>admin/settings/save_system" method="post"
            ...
            <section class="panel panel-custom">
                        ...
                        <div class="col-lg-3">
                            <select name="date_format" class="form-control">
                                ...
                                <option
                                    value="%Y.%m.%d"<?= ($date_format == "%Y.%m.%d" ? ' selected="selected"' : '') ?>><?= strftime("%Y.%m.%d", time()) ?></option>
                                <option
                                    value="%A %d, %b, %Y | %H:%M"<?= ($date_format == "%A %d, %b, %Y | %H:%M" ? ' selected="selected"' : '') ?>><?= date('D d, M, Y | H:i') ?></option>
                                <option
                                    value="%A, %m - %d - %y | %H:%M"<?= ($date_format == "%A, %m - %d - %y | %H:%M" ? ' selected="selected"' : '') ?>><?= date('D, d - m - Y | H:i'); ?></option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <hr />
                <h4 style="padding:0 10px;"><?=lang('setting_sms')?></h4>
                <hr />
                    <div class="form-group">
                        <label class="col-lg-3 control-label"><?= lang('sms_username') ?></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control" value="<?= config_item('sms_username') ?>"
                                   name="sms_username">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-3 control-label"><?= lang('sms_password') ?></label>
                        <div class="col-lg-9">
                            <input type="password" class="form-control" value="<?= config_item('sms_password') ?>"
                                   name="sms_password">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-3 control-label"><?= lang('sms_sender') ?></label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control" value="<?= config_item('sms_sender') ?>"
                                   name="sms_sender">
                        </div>
                    </div>
                <div class="form-group">
