        ...
        <div class="row mb-lg">
            <div class="col-lg-4 col-xs-6 br pv">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        <address><?= (config_item('company_address_' . $client_lang) ? config_item('company_address_' . $client_lang) : config_item('company_address')) ?></address>
            ...
            <div class="col-lg-4 col-xs-6 br pv">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <h4><?= $client_name ?></h4>
                        <?php if (!empty($address)) { ?><address><?= $address ?></address><?php } ?>
                        <?php if (!empty($city)) { ?><br> <?= $city ?>, <?php } ?><?php if (!empty($zipcode)) { ?><?= $zipcode ?><?php } ?>
                        <?php if (!empty($country)) { ?><br><?= $country ?><?php } ?>
                        <?php if (!empty($phone)) { ?><br><?= $language_info['phone'] ?>: <?= $phone ?><?php } ?>
       ...
       <div id="resultSend"></div>
        ...
        <div class="form-group clearfix">
                            ...
                            <textarea id="message" name="message" class="form-control"
                                                            rows="6"><?= lang('estimate_sms_template') ?></textarea>
                                                            </div>
                        </div>
                        <hr />
      <div class="form-group clearfix">
