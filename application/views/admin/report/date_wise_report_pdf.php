...
<div style="width: 100%;">
    <table cellspacing="0" cellpadding="4" border="0" width="100%">
        <tr>
            ...
            <th style="border:1px solid #333333; text-align:center;" bgcolor="#dddddd"><?= lang('method') ?></th>
        ...
        if (!empty($all_transaction_info)): foreach ($all_transaction_info as $v_transaction) :
            ...
            $mtd = $this->report_model->check_by(array('payment_methods_id' => $v_transaction->payment_methods_id), 'tbl_payment_methods');
           ?>
            ...
            <tr style="width: 100%;">
                ...
                <td><?php if($mtd){ echo $mtd->method_name; } ?></td>
