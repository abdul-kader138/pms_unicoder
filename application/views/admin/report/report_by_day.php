...
<div class="row">
    <div class="col-sm-6" style="margin:0px auto; float:none;">
        <form action="<?php echo base_url() ?>admin/report/report_by_day" method="post">
            <label for="field-1" class="control-label pull-left holiday-vertical"><strong><?= lang('day') ?>:</strong></label>
            <div class="col-sm-10">
                <input type="text" name="year" class="form-control years2" value="<?php
                if (!empty($year)) {
                    echo $year;
                }
...
<div id="expense_report">
    ...
    <div class="row">
        <div class="col-md-12"><!-- ************ Expense Report Content Start ************-->
            <div class="tab-content">
                    <div id="Liistt" class="tab-pane active">
                    ...
                    ?>
                                        ...
                                        <div class="pull-right hidden-print">
                                            <span><?php echo btn_pdf('admin/report/report_by_day_pdf/' . $year); ?></span>
...
<script type="text/javascript">
	  $('.years').on('dp.change', function (e) {
		  var value = $(this).val();
		  var firstDate = moment(value, "mm-dd-yyyy").day(0).format("mm-dd-yyyy");
		  var lastDate =  moment(value, "mm-dd-yyyy").day(6).format("mm-dd-yyyy");
		  $("input[name=year]").val(lastDate);
	  });
