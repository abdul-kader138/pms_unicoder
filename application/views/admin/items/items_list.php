        ...
        <div class="tab-pane <?= $active == 1 ? 'active' : ''; ?>" id="manage">
                    ...
                    <table class="table table-striped DataTables " id="DataTables" cellspacing="0" width="100%">
                        ...
                        foreach ($all_items as $v_items):
                            ...
                            <tr id="table_items_<?= $v_items->saved_items_id ?>">
                                <td><?= $k ?></td>
                                <td><strong class="block"><div align="left" dir="rtl"><?= $item_name ?></div></strong>
                                   <div align="left" dir="rtl"> <?= nl2br($v_items->item_desc) ?></div>
                                </td>
                                <?php
                                $invoice_view = config_item('invoice_view');
                                if (!empty($invoice_view) && $invoice_view == '2') {
            ...
            <div class="tab-pane <?= $active == 2 ? 'active' : ''; ?>" id="create">
                <form role="form" data-parsley-validate="" novalidate="" enctype="multipart/form-data" id="form"
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label"><?= lang('group') ?> </label>
                        <div class="col-lg-5">
