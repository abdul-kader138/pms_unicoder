...
<div class="<?= $lcol ?>">
    ...
    <?php } ?>
    <ul class="navbar-left list-unstyled" style="width: 30%;">
        <li><img  style="width: 100%;" src="<?= base_url() . config_item('company_logo') ?>" class="m-r-sm"></li>
    </ul>
    <div class="wrapper" style="margin: 10% 0 0 auto">
        ...
        <?php } ?>
            ...
            <div class="p-lg text-center">
                <span>&copy;</span>
<!--                <strong><a href="http://oneclicksolutionbd.com">OneclickSolutionBD</a>.</strong>-->
                <br/>
                <span>2017-<?php echo date("Y"); ?></span>
                <span>-</span>
