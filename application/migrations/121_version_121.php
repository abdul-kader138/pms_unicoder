...
class Migration_Version_121 extends CI_Migration
{
    ...
    public function up()
    {
        ...
        // codelover138
        $this->db->query("INSERT INTO `tbl_menu` (`menu_id`, `label`, `link`, `icon`, `parent`, `sort`, `time`, `status`) VALUES (NULL, 'sales', 'admin/report/sales_report', 'fa fa-shopping-cart', '42', '13', CURRENT_TIMESTAMP, '1');");
        //
